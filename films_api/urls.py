...
urlpatterns = [
    ...
    url(r'^api/v1/films/(?P<url_slug>[-\w]+)/$', api_controller.FilmDetail.as_view(lookup_field='url_slug')),
    url(r'^api/v1/films/(?P<pk>[0-9]+)/ratings/$', api_controller.FilmRatingList.as_view()),
    url(r'^api/v1/films/(?P<url_slug>[-\w]+)/ratings/$', api_controller.FilmRatingList.as_view(lookup_field='url_slug')),
